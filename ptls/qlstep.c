/* qlstep.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int qlstep(doublereal *u, integer *ldu, doublereal *v, 
...
/*         formed matrix S' J T. E(k+1) = 0 if k < min(M,N). */
/*     M - INTEGER. */
...
/*     [2] H. Bowdler, R.S. Martin and J.H. Wilkinson, The QR and QL */
/*         algorithms for symmetric matrices. Numer. Math., 11 (1968), */
/*         293-306. */
